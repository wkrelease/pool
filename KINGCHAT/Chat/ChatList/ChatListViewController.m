...
{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.searchBar.frame.size.height+20, self.view.frame.size.width, self.view.frame.size.height - self.searchBar.frame.size.height-72) style:UITableViewStylePlain];
    ...
    if (_searchController == nil) {
        ...
        [_searchController setCellForRowAtIndexPathCompletion:^UITableViewCell *(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            if (!conversation.isGroup) {
                cell.placeholderImage = [UIImage imageNamed:@"kingppp@2x.png"];
            }
            else{
...
-(UITableViewCell *)tableView:(UITableView *)tableView
    ...
    EMMessage *mes = (EMMessage *)[conversation latestMessageFromOthers];
...
//    
//    
//    NSLog(@"%@",[[conversation latestMessageFromOthers]class]);
//    
//    cell.name = [conversation.chatter base64DecodedString];
//
//    NSLog(@"%@",cell.name);
//    
//    EMMessage *mes = (EMMessage *)[conversation.messages lastObject];
    
    NSLog(@"%lu",(unsigned long)conversation.messages.count);
    NSLog(@"%@",conversation.messages);
//    NSLog(@"%@",[mes.ext objectForKey:@"header"]);
    cell.name = [mes.ext objectForKey:@"username"];
    
    if (!conversation.isGroup) {
//        cell.placeholderImage = [UIImage imageNamed:@"chatListCellHead.png"];    
        cell.imageURL = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",HeadImg,[mes.ext objectForKey:@"header"]]];
        if (!cell.imageURL) {
            cell.placeholderImage = [UIImage imageNamed:@"kingppp@2x.png"];
        }
    }
