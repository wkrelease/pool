...
#pragma mark KINGKINGKING
    
//    [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(fireDele) userInfo:nil repeats:YES];
    
    
#define MARK ENDEDNEDN
    

    
    navBar=[Control creatImageView:CGRectMake(0, 0, self.view.frame.size.width, 44+[UIApplication sharedApplication].statusBarFrame.size.height) imageName:@"Menu-Frame"];
    ...
    UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(60, 20, SCREEN_WIDTH  -120, 44)];
    
    label.text=@"聊天";
    
    label.font = [UIFont fontWithName:FONTWITHNAME_HEITI size:16.0f];
...
//    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 64, 44, 44)];
...
//    if (_isChatGroup) {
//        UIButton *detailButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 64, 60, 44)];
...
//    }
//    else{
//        UIButton *clearButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 64, 44, 44)];
...
//        _chatToolBar.toolbarBackgroundImage = [UIImage imageNamed:@"kingBAA"];
    }
...
//        
//        EMMessage *msg = [[EMMessage alloc]initWithReceiver:_conversation.chatter bodies:message];
//        
...
////    objKey:obj对应的key
//        
//        [vcardProperty setObject:message forKey:@"message"];
//        
//        NSString *header = @"";
//        NSString *name = @"";
//        
...
//        }
//        
//        [vcardProperty setObject:header forKey:@"header"];
//        
//        [vcardProperty setObject:name forKey:@"name"];
//        
//        msg.ext = vcardProperty;
//        
//        NSLog(@" === msg.text = %@",msg.ext);
//        
//        [self addChatDataToMessage:msg];
...
//        // objKey:obj对应的key
//        
//        NSString *hea = [NSString stringWithFormat:@"%@%@",HeadImg,[message.ext objectForKey:@"header"]];
//        
////        [vcardProperty setObject:[message.ext objectForKey:@"message"] forKey:@"message"];
////        [vcardProperty setObject:[message.ext objectForKey:@"name"] forKey:@"name"];
//
//        [vcardProperty setObject:hea forKey:@"header"];
//        
//        if (message.ext) {
//            
//            NSString *nam = [message.ext objectForKey:@"username"];
//            
//            [vcardProperty setObject:nam forKey:@"username"];
//            
//            NSLog(@"%@",nam);
//            
//        }
...
//        // objKey:obj对应的key
//        
//        mess = [message.ext objectForKey:@"message"];
//        
//        header = [NSString stringWithFormat:@"%@%@",HeadImg,[message.ext objectForKey:@"header"]];
//        
//        name = [message.ext objectForKey:@"name"];
//        
//    }
    
//    [self.messageModel setContent:mess];//给self.messModel重新赋值
//    
//    _bubbleView.model = self.messageModel;
//    
//    [_bubbleView sizeToFit];
    
//    NSRange rang=[header rangeOfString:@"http:"];
    
//    if (rang.location==NSNotFound) {
//        
//        header = [NSString stringWithFormat:@"%@%@",HeadImg,header];
//        
////        [self.headImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",header]]placeholderImage:[UIImage imageNamed:@"morenHeaderImage"]];
//        
//    }else{
//        
//        [self.headImageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",header]]placeholderImage:[UIImage imageNamed:@"morenHeaderImage"]];
...
#pragma mark 阅后即焚
- (void)moreViewFireAction:(DXChatBarMoreView *)moreView{
...
//    
//#pragma mark kkkkkk
////    [self sendHasReadResponseForMessage:tempMessage];
//
//    [self addChatDataToMessage:tempMessage];
    ...
    NSUserDefaults *upsuser=[NSUserDefaults standardUserDefaults];
    
    
//    NSString *header = [NSString stringWithFormat:@"%@%@",HeadImg,[[upsuser objectForKey:@"userEmg"] objectForKey:@"header"]];
    
    NSString *header = [NSString stringWithFormat:@"%@",[[upsuser objectForKey:@"userEmg"] objectForKey:@"header"]];

    
    NSString *name = [[upsuser objectForKey:@"userEmg"] objectForKey:@"username"];
    //
    //    NSString *json = [NSString stringWithFormat:@"{\"message\":\"%@\",\"nickname\":\"%@\",\"header\":\"%@\"}",textMessage,nickname,header];
    //
    //    NSLog(@"%@",json);
    //
    //    EMMessage *tempMessage = [ChatSendHelper sendTextMessageWithString:json toUsername:_conversation.chatter isChatGroup:_isChatGroup requireEncryption:NO];
    //
    //    [self addChatDataToMessage:tempMessage];
    ...
    // objKey:obj对应的key
   	...
   	[vcardProperty setObject:textMessage forKey:@"message"];
    ...
    [vcardProperty setObject:name forKey:@"username"];
