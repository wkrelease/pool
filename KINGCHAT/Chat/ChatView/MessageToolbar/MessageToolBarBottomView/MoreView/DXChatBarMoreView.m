...
//    [_takePicButton setFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE , 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    ...
    [_videoButton setFrame:CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3 , 20, CHAT_BUTTON_SIZE - 18, CHAT_BUTTON_SIZE- 18)];
    ...
    [_fireBtn setFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2 + 5, 20, CHAT_BUTTON_SIZE-18 , CHAT_BUTTON_SIZE -18)];
    [_fireBtn setImage:[UIImage imageNamed:@"chat_fireoff"] forState:UIControlStateNormal];
    [_fireBtn setImage:[UIImage imageNamed:@"chat_fireon"] forState:UIControlStateSelected];
    [_fireBtn addTarget:self action:@selector(fireAction:) forControlEvents:UIControlEventTouchUpInside];
